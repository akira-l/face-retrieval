...
from get_resnet_fpn import FeaturePyramid
...
class RetinaNet(nn.Module):
    ...
    def forward(self, x):
        ...
        for fms_counter in range(5):
            h, w = fms[fms_counter].size()[2:]
            fms_get.append(fms[fms_counter]*F.adaptive_max_pool2d(attention, (h,w)))
        ...
        return torch.cat(loc_preds,1), torch.cat(cls_preds,1), attention
